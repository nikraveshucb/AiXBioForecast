...
st.write(" ")
st.markdown("<h1 style='text-align: left; color: turquoise;'> AiX - AI Model6</h1>", unsafe_allow_html=True)
st.write("AiX-AI Model 6 accuracy score : ", 1-np.mean([rf_acc, knn_acc, d3_acc]))
